...
- **The post-2008 layer carries the *older* boundaries for Assam and J&K.** Assam was
  ...
  - **Assam's 2023 *assembly* (126 redrawn ACs) is not included** - it isn't available
    as open geospatial data anywhere as of mid-2026 (only the ECI's PDF order exists).
    It would need digitising from that PDF.
